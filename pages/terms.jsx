  ...
  return (
    <div className="container mx-auto px-10 mb-8 bg-white py-2 rounded">
      ...
      <h3 className="text-gray-800 my-4">
        ...
        hesitate to contact us. Our Privacy Policy was generated with the help
        of GDPR Privacy Policy Generator from GDPRPrivacyNotice.com General Data
        Protection Regulation (GDPR) We are a Data Controller of your
        information. keytosuccess legal basis for collecting and using the
        ...
        collect the information: keytosuccess needs to perform a contract with
        you You have given keytosuccess permission to do so Processing your
        personal information is in keytosuccess legitimate interests
        keytosuccess needs to comply with the law keytosuccess will retain your
        personal information only for as long as is necessary for the purposes
        set out in this Privacy Policy. We will retain and use your information
        to the extent necessary to comply with our legal obligations, resolve
        disputes, and enforce our policies. If you are a resident of the
        ...
        and if you want it to be removed from our systems, please contact us. In
        certain circumstances, you have the following data protection rights:
        The right to access, update or to delete the information we have on you.
        The right of rectification. The right to object. The right of
        restriction. The right to data portability The right to withdraw consent
        Log Files keytosuccess follows a standard procedure of using log files.
        ...
        keytosuccess uses 'cookies'. These cookies are used to store information
        ...
        Generator. Google DoubleClick DART Cookie Google is one of a third-party
        ...
        consult this list to find the Privacy Policy for each of the advertising
        partners of keytosuccess. Third-party ad servers or ad networks uses
        technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on keytosuccess,
        ...
        that keytosuccess has no access to or control over these cookies that
        ...
        browsers' respective websites. Children's Information Another part of
        ...
        monitor and guide their online activity. keytosuccess does not knowingly
        ...
        information from our records. Online Privacy Policy Only Our Privacy
        ...
        collect in keytosuccess. This policy is not applicable to any
