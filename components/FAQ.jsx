...
const FAQ = ({ post }) => {
  ...
  useEffect(() => {
    ...
    fetchFAQs();
  }, [post?.slug, post?.title, getContentText]);
  ...
  if (loading) {
    return (
      <section className="mt-12 mb-8">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-50 to-white border border-gray-100 p-6">
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {expandedIndex === index && (
                        ...
                        >
                          <p className="mt-4 pt-4 border-t border-gray-100 text-sm sm:text-base text-gray-600 leading-relaxed">
                            {faq.answer}
                          </p>
                        </motion.div>
                      )}
