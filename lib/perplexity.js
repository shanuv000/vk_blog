...
- Do NOT include citation markers or reference numbers like [1], [2], [3] in your answers
...
Content excerpt: ${truncatedContent}`;
  ...
  try {
    ...
    try {
      ...
      // Validate FAQ structure and clean citation markers
      const validFaqs = faqs
        ...
        .map((faq) => ({
          ...
          answer: faq.answer
            .replace(/\[\d+\](\[\d+\])*/g, '')  // Remove [1][2][3] style citations
